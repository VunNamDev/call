        ...
        <View style={{ alignItems: 'center', width: width - 40, flex: 1 }}>
            ...
            <TouchableOpacity
              onPress={() => {
                if (this.number == '') {
                  ...
                  Search(this.props.store.countryCode, this.number).then(val => {
                    ...
                    this.props.navigation.navigate('SearchInforScreen', { val: val });
                  });
                }
              }}
            >
          ...
          >
            ...
            <View style={{ flex: 1, alignItems: 'flex-end' }}>
              ...
              >
                <Text style={{ fontSize: 16, fontWeight: 'bold' }}>Delete All</Text>
              </TouchableOpacity>
            </View>
          </View>
          <View
