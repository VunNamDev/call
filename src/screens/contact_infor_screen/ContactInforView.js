      ...
      <View style={{ flex: 1, backgroundColor: '#FAFAFA', alignItems: 'center' }}>
        ...
        >
          ...
          <View style={{ height: 80, flex: 1 }}>
            ...
            <Text style={{ color: '#6A6A6A', fontSize: 16, marginTop: 5 }}>{this.state.location}</Text>
          </View>
          <TouchableOpacity
            onPress={() => {
          ...
          >
            <Text style={{ fontSize: 16, color: '#FFF' }}>MAP</Text>
        ...
        >
          ...
          >
            ...
            />
            <Text style={{ color: '#6A6A6A', fontSize: 18 }}>{this.contactName}</Text>
          </View>
          ...
          >
            <Text style={{ fontSize: 18, color: '#B0B0B0', marginLeft: 20 }}>NUMBER</Text>
