    ...
    return (
      <View style={{ flex: 1, backgroundColor: '#FAFAFA', alignItems: 'center' }}>
        ...
        <View style={{ height: 40, width: width, alignItems: 'center', marginTop: 50 }}>
          <Text style={{ color: '#FFF', fontSize: 20, fontWeight: 'bold' }}>MENU</Text>
        </View>
        <TouchableOpacity
          style={{
            alignItems: 'center',
        ...
        >
          ...
          />
          <Text style={{ color: '#474747', fontSize: 20 }}>Rate App!</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={{
            alignItems: 'center',
        ...
        >
          ...
          />
          <Text style={{ color: '#474747', fontSize: 20 }}>Contact us</Text>
        </TouchableOpacity>
        ...
        >
          ...
          />
          <Text style={{ color: '#474747', fontSize: 20 }}>Share App</Text>
        </TouchableOpacity>
      </View>
    );
  }
